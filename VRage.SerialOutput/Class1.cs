...
namespace VRage.SerialOutput
{
    ...
    public class SerialOut
    {
        ...
        ///</summary>
         public bool SendMessageToSerial(String Message, String devicename)//Change Bool for routing to SE log file.
        {
            bool success = false;
         ...
         ///</summary>
         public bool SendMessageToSerial(String Message, int COMPortNumber)//Change Bool for routing to SE log file.
         {
             bool success = false;
